            ...
            <div class="col-md-12">
                <div class="card card-info card-outline">
                    ...
                    <div class="card-body">
                        ...
                        <form role="form" action="{{route('setting.contact.update',$contact->id)}}" method="post" enctype="multipart/form-data" >
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="title" placeholder="" style="direction: ltr;" id="name" class="border-info text-right form-control " value="{{$contact->title}}"   >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="slug" placeholder="" style="direction: ltr;" id="slug" class="border-info form-control text-right "  value="{{$contact->slug}}" >
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body pad">
                                        <div class="mb-3">
                                                <textarea class="textarea text-right" placeholder="لطفا متن خود را وارد کنید" name="content"
                                                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{!! $contact->content !!}</textarea>
                                        </div>
                                    </div>
                                </div>
